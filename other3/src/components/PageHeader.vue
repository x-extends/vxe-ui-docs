    ...
    <div class="header-right">
      <vxe-pulldown v-model="showPluginApp" show-popup-shadow>
        <vxe-button class="system-menu-btn" mode="text" @click="togglePluginAppEvent">
          <span v-if="pluginType" class="system-menu-btn-text" style="color: orange;">{{ $t('app.header.morePlugin') }} - {{ currBuyPluginName }}</span>
          <span v-else class="system-menu-btn-text" style="color: orange;">{{ $t('app.header.pluginDocs') }}</span>
