  ...
  <div>
    <CodeLight>
      ...
      <template #use>
        <pre>
          <pre-code>
            npm install vxe-pc-ui@3.1.24 vxe-table@3.9.0 @vxe-ui/plugin-export-xlsx@3 exceljs
            # 或者
            yarn add vxe-pc-ui@3.1.24 vxe-table@3.9.0 @vxe-ui/plugin-export-xlsx@3 exceljs
          </pre-code>
        </pre>
