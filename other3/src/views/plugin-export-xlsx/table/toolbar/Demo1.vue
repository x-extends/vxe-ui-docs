<template>
  <div>
    <vxe-table
      ...
      <vxe-column field="code" title="Name"></vxe-column>
      <vxe-column field="role" title="字符串类型" cell-type="string"></vxe-column>
      <vxe-colgroup title="分组1">
        <vxe-column field="num1" title="数值" :cell-render="{ name: 'FormatNumberInput', props: { type: 'float' } }"></vxe-column>
        <vxe-column field="num2" title="数值（负数标红）" :cell-render="{ name: 'FormatNumberInput', showNegativeStatus: true, props: { type: 'float' } }"></vxe-column>
      </vxe-colgroup>
      <vxe-column field="amount1" title="货币" :cell-render="{ name: 'FormatNumberInput', props: { type: 'amount', showCurrency: true } }"></vxe-column>
      <vxe-column field="amount2" title="货币（负数标红）" :cell-render="{ name: 'FormatNumberInput', showNegativeStatus: true, props: { type: 'amount', showCurrency: true } }"></vxe-column>
