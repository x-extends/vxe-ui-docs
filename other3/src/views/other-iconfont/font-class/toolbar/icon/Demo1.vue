  ...
  data () {
    const gridOptions: VxeGridProps<RowVO> = {
      ...
      toolbarConfig: {
        refresh: true,
        refreshOptions: {
          icon: 'mytesticonfont mytest-search',
          iconLoading: 'mytesticonfont mytest-closure roll'
        },
        import: true,
        importOptions: {
          icon: 'mytesticonfont mytest-assets'
        },
        export: true,
        exportOptions: {
          icon: 'mytesticonfont mytest-link'
        },
        print: true,
        printOptions: {
          icon: 'mytesticonfont mytest-ransmission'
        },
        zoom: true,
        zoomOptions: {
          iconIn: 'mytesticonfont mytest-switch',
          iconOut: 'mytesticonfont mytest-closure'
        },
        custom: true,
        customOptions: {
          icon: 'mytesticonfont mytest-Telephone'
        }
      },
      proxyConfig: {
        response: {
