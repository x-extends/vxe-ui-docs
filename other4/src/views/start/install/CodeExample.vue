    ...
    <CodeLight>
      <template #tip>
        <vxe-tip status="primary" title="NPM 方式">
          ...
          <div>依赖库：<vxe-link href="https://util.vxeui.com" target="_blank">xe-utils 3.0+</vxe-link>、<vxe-link  href="https://cn.vuejs.org/v2/guide/components-slots.html#%E5%8A%A8%E6%80%81%E6%8F%92%E6%A7%BD%E5%90%8D">vue 3.2+</vxe-link></div>
        </vxe-tip>
      </template>
