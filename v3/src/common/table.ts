  ...
  children: [
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '显示多列合计', routerLink: { name: 'ComponentTableRowGroupCount' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '自定义表头标题模板', routerLink: { name: 'ComponentTableTemplateTitle' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '指定数据', routerLink: { name: 'ComponentTableExportData' } },
        ...
        },
        {
          title: '事件监听',
          children: [
            { title: '准备就绪', routerLink: { name: 'ComponentTableEventsReady' } },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '使用合并列来展示分类', routerLink: { name: 'ComponentGridMergeVnGroup' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '可取消', routerLink: { name: 'ComponentGridCurrentRowStrict' } }
          ]
        },
        {
          title: '行高调整',
        ...
        },
        {
          ...
          children: [
            ...
            { title: '弹出层展示模式', routerLink: { name: 'ComponentGridCustomMaxHeight' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '自定义标题模板', routerLink: { name: 'ComponentGridTemplateTitle' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'Tab键最后自动新增行', routerLink: { name: 'ComponentGridKeyTabAppend' } },
            { title: '回车键最后自动新增行', routerLink: { name: 'ComponentGridKeyboardEnterAppend' } },
        ...
        },
        {
          title: '事件监听',
          children: [
            { title: '准备就绪', routerLink: { name: 'ComponentGridEventsReady' } },
    ...
    },
    {
      ...
      children: [
        ...
        { title: '斑马线条纹背景色', routerLink: { name: 'CssVarTableStripe' } },
