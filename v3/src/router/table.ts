...
export const tableRouteConfig: RouteConfig = {
  path: 'table',
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'spanMethod', name: 'ComponentTableRowGroupSpanMethod', component: () => import('@/views/table/rowGroup/spanMethod/CodeExample.vue') },
