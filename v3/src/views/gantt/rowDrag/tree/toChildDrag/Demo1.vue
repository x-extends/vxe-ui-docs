  ...
  data () {
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        ...
        { id: 10006, parentId: 10003, title: '一个小目标项目', start: '2024-03-10', end: '2024-03-21', progress: 5 },
        ...
        { id: 10010, parentId: null, title: '铁路修建计划', start: '2024-03-12', end: '2024-03-20', progress: 10 }
      ]
    }
