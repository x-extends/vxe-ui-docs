<template>
  <div>
    <vxe-gantt v-bind="ganttOptions" @page-change="pageChangeEvent"></vxe-gantt>
  </div>
</template>

<script lang="ts">
import Vue from 'vue'
import type { VxeGanttProps, VxeGanttPropTypes } from 'vxe-gantt'
...
export default Vue.extend({
  data () {
    const pagerVO: VxeGanttPropTypes.PagerConfig = {
      total: 0,
      currentPage: 1,
      pageSize: 10,
