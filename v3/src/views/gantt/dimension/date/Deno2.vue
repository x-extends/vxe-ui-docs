  ...
  data () {
    ...
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        ...
        { id: 10002, name: '任务C309', start: '2024-01-03', end: '2024-03-08', progress: 10 },
        ...
        { id: 10005, name: '任务L843', start: '2024-07-08', end: '2024-08-15', progress: 100 },
        { id: 10006, name: '任务B567', start: '2024-08-10', end: '2024-11-21', progress: 5 },
        { id: 10007, name: '任务V510', start: '2024-03-15', end: '2024-08-24', progress: 70 },
