...
export default Vue.extend({
  data () {
    ...
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        { id: 10001, name: '任务R790', start: '2023-08-01', end: '2024-11-15', progress: 3 },
        { id: 10002, name: '任务C30456572349', start: '2024-01-03', end: '2024-03-08', progress: 10 },
        { id: 10003, name: '任务E563', start: '2024-05-03', end: '2024-07-11', progress: 90 },
        { id: 10004, name: '任务P687', start: '2024-04-05', end: '2024-06-11', progress: 15 },
        { id: 10005, name: '任务L8412430903', start: '2024-07-08', end: '2024-08-15', progress: 100 },
        { id: 10006, name: '任务B567', start: '2024-08-10', end: '2024-11-21', progress: 5 },
        { id: 10007, name: '任务V513802134450', start: '2024-03-15', end: '2024-08-24', progress: 70 },
        { id: 10008, name: '任务G110', start: '2024-03-20', end: '2024-03-29', progress: 50 },
        { id: 10009, name: '任务I802', start: '2025-01-19', end: '2025-03-18', progress: 5 },
        { id: 10010, name: '任务K778', start: '2024-12-12', end: '2025-02-10', progress: 10 }
      ]
    }
