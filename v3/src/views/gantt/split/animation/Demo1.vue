<template>
  <div>
    <vxe-switch v-model="taskSplitConfig.animation"></vxe-switch>
...
export default Vue.extend({
  data () {
    const taskSplitConfig: VxeGanttPropTypes.TaskSplitConfig = {
      animation: true
    }
    ...
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        { id: 10002, name: '任务C309', start: '2024-03-03', end: '2024-03-08', progress: 10 },
