  ...
  data () {
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        ...
        { id: 10002, title: '任务C309', start: '2024-03-03', end: '2024-03-08', progress: 10, owner: '小徐' },
        ...
        { id: 10005, title: '任务L843', start: '2024-03-08', end: '2024-03-15', progress: 100, owner: '老六' },
        { id: 10006, title: '任务B567', start: '2024-03-10', end: '2024-03-21', progress: 5, owner: '小明' },
        { id: 10007, title: '任务V510', start: '2024-03-15', end: '2024-03-24', progress: 70, owner: '王五' },
