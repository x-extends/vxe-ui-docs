  ...
  data () {
    const ganttOptions: VxeGanttProps<RowVO> = {
      ...
      data: [
        ...
        { id: 10008, title: '某某科技项目', start: '2024-03-20', end: '2024-04-08', progress: 50 },
        { id: 10009, title: '地铁建设工程', start: '2024-04-02', end: '2024-04-11', progress: 5 },
        { id: 10010, title: '铁路修建计划', start: '2024-04-12', end: '2024-04-20', progress: 10 }
      ]
    }
