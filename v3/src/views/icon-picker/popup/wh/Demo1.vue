<template>
  <div>
    <vxe-icon-picker v-model="val1" :icon="iconList" :popup-config="popupConfig" clearable></vxe-icon-picker>
  </div>
</template>
