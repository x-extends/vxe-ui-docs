    ...
    <CodeLight>
      <template #tip>
        <vxe-tip status="primary" title="方式三：自定义全局 scss 变量">
          通过修改 scss 变量（<vxe-link href="https://gitee.com/x-extends/vxe-pc-ui/blob/v3/styles/variable.scss" status="primary" target="_blank">查看全部变量</vxe-link>）方式全局修改组件样式，示例：
        </vxe-tip>
      </template>
