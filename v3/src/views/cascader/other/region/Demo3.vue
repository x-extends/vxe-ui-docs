<template>
  <div>
    <vxe-cascader v-model="val1" :options="treeList" :treeConfig="treeConfig" :radio-config="radioConfig" :option-props="{value: 'id', label: 'name'}" show-full-label filterable clearable></vxe-cascader>
  </div>
</template>
