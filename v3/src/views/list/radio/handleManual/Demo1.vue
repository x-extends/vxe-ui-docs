<template>
  <div>
    ...
    <vxe-list :check-row-key.sync="checkRowKey" v-bind="listOptions"></vxe-list>
  </div>
</template>
...
export default Vue.extend({
  data () {
    ...
    const checkRowKey = null as VxeListPropTypes.CheckRowKey
  ...
  methods: {
    selectRadioEvent () {
      this.checkRowKey = '10011'
    },
    clearRadioEvent () {
      this.checkRowKey = null
    },
    getRadioEvent () {
      VxeUI.modal.alert(`${this.checkRowKey}`)
    }
  }
})
</script>
