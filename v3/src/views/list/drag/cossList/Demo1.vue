...
export default Vue.extend({
  ...
  methods: {
    resultEvent1 () {
      const $list = this.$refs.listRef1 as VxeListInstance<RowVO>
      if ($list) {
    ...
    resultEvent2 () {
      const $list = this.$refs.listRef2 as VxeListInstance<RowVO>
      if ($list) {
        const listData = $list.getFullData()
        console.log(listData)
      }
    ...
    resultEvent3 () {
      const $list = this.$refs.listRef3 as VxeListInstance<RowVO>
      if ($list) {
        const listData = $list.getFullData()
        console.log(listData)
      }
