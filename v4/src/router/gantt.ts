  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'weekDayDate', name: 'ComponentGanttScalesWeekDayDate', component: () => import('@/views/gantt/scales/weekDayDate/CodeExample.vue') },
        ...
        { path: 'headerCellStyle', name: 'ComponentGanttScalesHeaderCellStyle', component: () => import('@/views/gantt/scales/headerCellStyle/CodeExample.vue') },
        {
          ...
          children: [
            ...
            { path: 'monthDayDate', name: 'ComponentGanttScalesStepMonthDayDate', component: () => import('@/views/gantt/scales/step/monthDayDate/CodeExample.vue') },
