  ...
  app: {
    ...
    body: {
      ...
      other: {
        ...
        plan: {
          v1: 'v1.x 基于 vue2.6，支持所有主流的浏览器，实现表格的一切实用的功能',
          v2: 'v2.x 基于 vue2.6，支持所有主流的浏览器，同时兼具功能与性能',
          v3: 'v3.x 基于 vue2.6，支持现代浏览器并部分兼容 IE11，提升渲染性能',
          v4: 'v4.x 基于 vue3.x，只支持现代浏览器，不支持 IE'
        },
        compatibility: '兼容性变动',
        releases: '更新日志',
        donation: '支持我们',
