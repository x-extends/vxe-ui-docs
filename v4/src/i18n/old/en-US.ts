    ...
    body: {
      ...
      other: {
        ...
        plan: {
          ...
          v3: 'v3.x Based on vue2.6, Support for modern browsers and partial compatibility with IE11 to improve rendering performance',
          v4: 'v4.x Based on vue3.x, Only supports modern browsers, not IE'
        },
