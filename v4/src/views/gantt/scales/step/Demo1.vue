...
const ganttOptions = reactive<VxeGanttProps<RowVO>>({
  ...
  data: [
    ...
    { id: 10008, title: '任务G110', start: '2024-03-20', end: '2024-04-08', progress: 50 },
    { id: 10009, title: '任务I802', start: '2024-04-02', end: '2024-04-11', progress: 5 },
    { id: 10010, title: '任务K778', start: '2024-04-12', end: '2024-04-20', progress: 10 }
  ]
})
</script>
