<template>
  <div>
    <vxe-button status="primary" @click="treeOptions.rootValues = ['3', '5']">设置 ['3', '5']</vxe-button>
    <vxe-button status="primary" @click="treeOptions.rootValues = ['2', '3', '4']">设置 ['2', '3', '4']</vxe-button>
