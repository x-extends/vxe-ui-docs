...
const treeRef3 = ref<VxeTreeInstance<NodeVO>>()
const treeOptions3 = reactive<VxeTreeProps<NodeVO>>({
  height: 400,
  transform: true,
  drag: true,
  dragConfig: {
