<template>
  <div>
    ...
    <vxe-drawer v-model="showDrawer1" position="left" width="80vw">
      <template #default>
        <div>内容1</div>
      </template>
    </vxe-drawer>
    ...
    <vxe-drawer v-model="showDrawer2" position="right" width="80vw">
      <template #default>
        <div>内容1</div>
      </template>
    </vxe-drawer>
    ...
    <vxe-drawer v-model="showDrawer3" position="top" height="80vh">
      <template #default>
        <div>内容1</div>
      </template>
    </vxe-drawer>
    ...
    <vxe-drawer v-model="showDrawer4" position="bottom" height="80vh">
      <template #default>
        <div>内容1</div>
      </template>
    </vxe-drawer>
