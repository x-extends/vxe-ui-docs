<template>
  <div>
    <div>
      <vxe-button status="primary" @click="loading = !loading">切换</vxe-button>
    </div>
    <vxe-table-select v-model="val1" :loading="loading" :columns="columnList" :options="tableData"></vxe-table-select>
  </div>
</template>
