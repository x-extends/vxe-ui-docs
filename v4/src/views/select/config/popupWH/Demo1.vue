...
const selectOptions: VxeSelectProps = {
  ...
  options: [
    ...
    { value: 1014, label: 'switch' },
    { value: 1015, label: 'tag' },
    { value: 1016, label: 'slider' },
    { value: 1017, label: 'tabs' },
    { value: 1018, label: 'text-ellipsis' },
    { value: 1019, label: 'input' },
    { value: 10120, label: 'menu' }
  ]
}
</script>
