<template>
  <div>
    <vxe-splitter height="300" :resize-config="resizeConfig" border resize>
      <vxe-splitter-panel>
        <vxe-splitter :resize-config="resizeConfig" border vertical>
...
const resizeConfig = reactive<VxeSplitterPropTypes.ResizeConfig>({
  immediate: true
})
</script>
