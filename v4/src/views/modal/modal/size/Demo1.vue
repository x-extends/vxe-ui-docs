<template>
  <div>
    <vxe-button content="默认尺寸" @click="val1 = true"></vxe-button>
      <vxe-modal v-model="val1" :width="600" :height="400">
        <template #default>
          <div>默认尺寸</div>
        </template>
      </vxe-modal>
      ...
      <vxe-modal v-model="val2" :width="600" :height="400" size="medium">
        <template #default>
          <div>中等尺寸</div>
        </template>
      </vxe-modal>
      ...
      <vxe-modal v-model="val3" :width="600" :height="400" size="small">
        <template #default>
          <div>小型尺寸</div>
        </template>
      </vxe-modal>
      ...
      <vxe-modal v-model="val4" :width="600" :height="400" size="mini">
        <template #default>
          <div>超小尺寸</div>
        </template>
      </vxe-modal>
