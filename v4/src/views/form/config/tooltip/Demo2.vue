...
const formOptions = reactive<VxeFormProps<FormDataVO>>({
  ...
  items: [
    ...
    { field: 'sex', title: '性别', span: 12, titlePrefix: { message: '左边图标', icon: 'vxe-icon-user-fill' }, titleSuffix: { message: '右边图标', icon: 'vxe-icon-warning-triangle' }, itemRender: { name: 'VxeInput' } },
