...
import { VxeFormProps, VxeFormItemPropTypes, VxeTableSelectProps } from 'vxe-pc-ui'
...
const currUserItemRender = reactive<VxeFormItemPropTypes.ItemRender<FormDataVO, VxeTableSelectProps>>({
  name: 'VxeTableSelect',
  props: {
    columns: [
...
const currUserListItemRender = reactive<VxeFormItemPropTypes.ItemRender<FormDataVO, VxeTableSelectProps>>({
  name: 'VxeTableSelect',
  props: {
    multiple: true,
    columns: [
...
const formOptions = reactive<VxeFormProps<FormDataVO>>({
  ...
  items: [
    ...
    { field: 'currUser', title: '下拉表格单选', span: 24, itemRender: currUserItemRender },
    { field: 'currUserList', title: '下拉表格多选', span: 24, itemRender: currUserListItemRender },
