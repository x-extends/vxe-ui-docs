<template>
  <div>
    <vxe-date-picker v-model="val1" type="datetime" placeholder="农历及节假日" :festival-method="festivalCalendarMethod"></vxe-date-picker>
  </div>
</template>
...
const val1 = ref('2020-10-01 00:00:00')
