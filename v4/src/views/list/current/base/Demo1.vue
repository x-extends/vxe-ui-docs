<template>
  <div>
    <div>
      <vxe-button status="primary" @click="selectCurrentEvent">选中10004</vxe-button>
      <vxe-button status="primary" @click="clearCurrentEvent">取消10004</vxe-button>
...
const getCurrentEvent = () => {
  const $list = listRef.value
  if ($list) {
    const selectId = $list.getCurrentRowKey()
