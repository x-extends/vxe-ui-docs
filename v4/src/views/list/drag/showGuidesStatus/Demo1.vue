<template>
  <div>
    样式：<vxe-switch v-model="dragConfig.showGuidesStatus"></vxe-switch>
    动画：<vxe-switch v-model="dragConfig.animation"></vxe-switch>
...
const dragConfig = reactive<VxeListPropTypes.DragConfig>({
