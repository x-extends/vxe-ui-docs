<template>
  <div>
    <vxe-radio-group v-model="rowConfig.height">
      <vxe-radio-button :checked-value="20" content="20px"></vxe-radio-button>
      <vxe-radio-button :checked-value="30" content="30px"></vxe-radio-button>
      <vxe-radio-button :checked-value="40" content="40px"></vxe-radio-button>
      <vxe-radio-button :checked-value="60" content="60px"></vxe-radio-button>
    </vxe-radio-group>
...
import { VxeListProps, VxeListPropTypes } from 'vxe-pc-ui'
...
const rowConfig = reactive<VxeListPropTypes.RowConfig>({
  contentField: 'label',
  height: 30
})
