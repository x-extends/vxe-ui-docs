<template>
  <div>
    ...
    <vxe-tabs v-model="selectTab" :position="tabPosition" type="border-card">
      ...
      <template #header>
        <div>
          <vxe-notice-bar content="vxe-table 企业级表格组件库、专业的表格库、高性能实现表格的复杂功能；vxe-pc-ui 企业级桌面端组件库，高性能的组件库；vxe-gantt 企业级甘特图，支持任务多维度、里程碑、可拖拽、连接线；vxe-design 可视化设计器，功能强大表单、列表设计器；快速搭建低代码平台、后台管理系统等。"></vxe-notice-bar>
        </div>
      </template>
    </vxe-tabs>
  </div>
...
const tabPosition = ref<VxeTabsPropTypes.Position>('left')
</script>
