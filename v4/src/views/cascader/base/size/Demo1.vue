<template>
  <div>
    <vxe-cascader v-model="val1" :options="treeList"></vxe-cascader>
    <vxe-cascader v-model="val2" :options="treeList" size="medium"></vxe-cascader>
    <vxe-cascader v-model="val3" :options="treeList" size="small"></vxe-cascader>
    <vxe-cascader v-model="val4" :options="treeList" size="mini"></vxe-cascader>
  </div>
</template>
