<template>
  <div>
    <vxe-switch v-model="showFullLabel"></vxe-switch>

    <vxe-cascader v-model="val1" :options="treeList" :show-full-label="showFullLabel" clearable></vxe-cascader>
  </div>
</template>
