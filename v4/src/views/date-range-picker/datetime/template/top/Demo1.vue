<template>
  <div>
    <vxe-date-range-picker ref="dateRangePickerRef" v-model:start-value="startDate" v-model:end-value="endDate" type="datetime">
      <template #top>
        ...
        <vxe-button mode="text" @click="selectLastRangeDate(-90)">最近60天</vxe-button>
      </template>
