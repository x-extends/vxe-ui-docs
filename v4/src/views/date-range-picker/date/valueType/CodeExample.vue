<template>
  <div>
    <CodeLight path="date-range-picker/date/valueType/Demo1">
      <template #tip>
    ...
    <CodeLight path="date-range-picker/date/valueType/Demo2">
      <template #tip>
    ...
    <CodeLight path="date-range-picker/date/valueType/Demo3">
      <template #tip>
