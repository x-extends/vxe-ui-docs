      ...
      <template #use>
        <pre>
          <pre-code class="javascript">
            ...
            VxeUI.use(VxeAlert)
            VxeUI.use(VxeAnchor)
            VxeUI.use(VxeAnchorLink)
            VxeUI.use(VxeAvatar)
            VxeUI.use(VxeBadge)
            VxeUI.use(VxeBreadcrumb)
            VxeUI.use(VxeBreadcrumbItem)
            VxeUI.use(VxeButton)
            VxeUI.use(VxeButtonGroup)
            VxeUI.use(VxeCalendar)
            VxeUI.use(VxeCard)
            VxeUI.use(VxeCarousel)
            VxeUI.use(VxeCarouselItem)
            VxeUI.use(VxeCheckbox)
            VxeUI.use(VxeCheckboxGroup)
            VxeUI.use(VxeCol)
            VxeUI.use(VxeCollapse)
            VxeUI.use(VxeCollapsePane)
            VxeUI.use(VxeColorPicker)
            VxeUI.use(VxeCountdown)
            VxeUI.use(VxeDatePanel)
            VxeUI.use(VxeDatePicker)
            VxeUI.use(VxeDateRangePicker)
            VxeUI.use(VxeDrawer)
            VxeUI.use(VxeEmpty)
            VxeUI.use(VxeForm)
            VxeUI.use(VxeFormDesign)
            VxeUI.use(VxeFormGather)
            VxeUI.use(VxeFormGroup)
            VxeUI.use(VxeFormItem)
            VxeUI.use(VxeFormView)
            VxeUI.use(VxeIcon)
            VxeUI.use(VxeIconPicker)
            VxeUI.use(VxeImage)
            VxeUI.use(VxeImageGroup)
            VxeUI.use(VxeImagePreview)
            VxeUI.use(VxeInput)
            VxeUI.use(VxeLayoutAside)
            VxeUI.use(VxeLayoutBody)
            VxeUI.use(VxeLayoutContainer)
            VxeUI.use(VxeLayoutFooter)
            VxeUI.use(VxeLayoutHeader)
            VxeUI.use(VxeLink)
            VxeUI.use(VxeListDesign)
            VxeUI.use(VxeListView)
            VxeUI.use(VxeList)
            VxeUI.use(VxeLoading)
            VxeUI.use(VxeMenu)
            VxeUI.use(VxeModal)
            VxeUI.use(VxeNoticeBar)
            VxeUI.use(VxeNumberInput)
            VxeUI.use(VxeOptgroup)
            VxeUI.use(VxeOption)
            VxeUI.use(VxePager)
            VxeUI.use(VxePasswordInput)
            VxeUI.use(VxePrintPageBreak)
            VxeUI.use(VxePrint)
            VxeUI.use(VxePulldown)
            VxeUI.use(VxeRadio)
            VxeUI.use(VxeRadioButton)
            VxeUI.use(VxeRadioGroup)
            VxeUI.use(VxeRate)
            VxeUI.use(VxeResult)
            VxeUI.use(VxeRow)
            VxeUI.use(VxeSelect)
            VxeUI.use(VxeSplit)
            VxeUI.use(VxeSplitPane)
            VxeUI.use(VxeSlider)
            VxeUI.use(VxeSteps)
            VxeUI.use(VxeSwitch)
            VxeUI.use(VxeTabPane)
            VxeUI.use(VxeTableSelect)
            VxeUI.use(VxeTabs)
            VxeUI.use(VxeTag)
            VxeUI.use(VxeTextEllipsis)
            VxeUI.use(VxeText)
            VxeUI.use(VxeTextarea)
            VxeUI.use(VxeTip)
            VxeUI.use(VxeTooltip)
            VxeUI.use(VxeTree)
            VxeUI.use(VxeTreeSelect)
            VxeUI.use(VxeUpload)
            VxeUI.use(VxeWatermark)
